 ...
 * 验证类使用的默认消息翻译工具.
 */
class Buddha_Validator_Translator extends Buddha_Base_Component implements Buddha_Validator_TranslatorInterface
{
    ...
    {
        $this->messages = array('validation' => array_merge($this->defaultMessages, $messages));
    }
